...
class _BookingScreenState extends State<BookingScreen> {
  ...
  //                           paymentSuccessful = await StripeService.instance
  //                               .makePayment(amountInSmallestUnit);
  ...
  //                               ),
  //                             );
  //                             return; // Exit the method if payment fails
  //                           }
  //                         } else if (_selectedPaymentMethod == 'Mobile Money') {
  //                           ScaffoldMessenger.of(context).showSnackBar(
  //                             SnackBar(
  //                               content: const Text(
  //                                   'Mobile Money payments are not yet supported.'),
  ...
  //                           return;
  //                         }
  //                         // Payment method is Cash or Procceding after credit card payment
  //                         final bookingData = {
  //                           'user_id': 7, // Replace with actual user ID
  //                           'service_id': widget.serviceId,
  //                           'service_provider_id': widget.serviceProviderId,
